...
subtitle: |
  ...
  <p class="subtitle is-4 has-text-white mt-6 mb-2">
    <a href="/services" class="button is-link is-normal is-hover has-text-black has-text-weight-bold" style="background-color: LawnGreen;"> Which gap can we bridge for you?</a>
  </p>

  <p class="subtitle is-4 has-text-white mt-2 mb-6">
    <a href="/open-source/set-outlooksignatures" class="button is-link is-normal is-hover has-text-black has-text-weight-bold" style="background-image: linear-gradient(to bottom, darkgoldenrod, #ffd700, #fff8dc, #ffd700, darkgoldenrod);"> Set-OutlookSignatures Benefactor Circle add-on</a>
  </p>
