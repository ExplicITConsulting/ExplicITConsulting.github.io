...
<div style="min-height: 100vh;">
  ...
  <p><a href="https://set-outlooksignatures.com"><button class="button is-link is-normal is-hover" style="background-color: lawngreen;">Set-OutlookSignatures and the Benefactor Circle add-on</button></a><p>
</div>