...
subtitle: |
  <p class="subtitle is-4 has-text-white" style="margin-bottom:0.3em">
    <span style="background-color: rgba(0, 0, 0, 0.2);">ExplicIT steht für spezifische, klare und detaillierte IT-Beratung.</span>
  </p>

  <p class="subtitle is-4 has-text-white" style="margin-bottom:0.3em; margin-top:0.3em">
    <span style="background-color: rgba(0, 0, 0, 0.2);">Mutig und zukunftsorientiert, immer realistisch und ohne Dampfplauderei.</span>
  </p>

  <p class="subtitle is-4 has-text-white" style="margin-top:0.3em;">
    <span style="background-color: rgba(0, 0, 0, 0.2);">Wir schließen Lücken, mit unserem Kopf in den Wolken und unseren Füßen fest am Boden.</span>
  </p>
